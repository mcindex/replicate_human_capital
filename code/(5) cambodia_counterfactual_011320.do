...
mmerge wbcode using "$output/gcf_pv_102219.dta", type(n:1) unmatched(master) ukeep(gcf_initial-gcf_sc5)
...
gr export "$graphs/cambodia_011320.png", as(png) width(2500) replace
gr export "$graphs/cambodia_011320.eps", as(eps)  replace
******************************
